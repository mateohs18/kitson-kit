...
import { 
  ...
  ShieldCheck, Loader2, Globe, FileImage, CheckCircle2 
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-orange-500">
      <header className="flex items-center justify-between p-4 md:px-8 border-b border-white/5 bg-[#050505]/90 backdrop-blur-xl sticky top-0 z-50">
        <Link href="/" className="flex items-center gap-3">
          ...
          <span className="text-2xl font-black text-white">Kitson <span className="text-orange-500">Kit</span></span>
        </Link>
        <div className="flex items-center gap-2 bg-white/5 px-4 py-2 rounded-full border border-white/10">
          <Globe size={16} className="text-gray-400" />
          <span className="text-sm font-bold text-gray-300">{activeCurrency.name} ({activeCurrency.currency})</span>
        </div>
      </header>
