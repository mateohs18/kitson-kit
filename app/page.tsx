                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            {r.verified && (
                              <span className="inline-flex items-center gap-1 bg-[#7BC77E]/15 text-[#7BC77E] text-[10px] font-black px-2 py-0.5 rounded-full border border-[#7BC77E]/30 ml-2">✓ Compra verificada</span>
                            )}
